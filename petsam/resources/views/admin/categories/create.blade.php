...
@section('title', 'PetSam Admin - Thêm Danh Mục Mới')
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" id="createForm">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" 
                 ...
                 id="name" 
                 name="name" 
                 placeholder="Nhập tên danh mục (vd: Mèo, Chó, Cá,....)"
                 value="{{ old('name') }}"
                 required>
          @error('name')
          ...
          @enderror
          <small class="form-text text-muted">Tên danh mục phải là duy nhất</small>
        </div>
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control @error('description') is-invalid @enderror" 
                  ...
                  name="description" 
                  rows="4" 
                  placeholder="Nhập mô tả chi tiết về danh mục (tùy chọn)">{{ old('description') }}</textarea>
        @error('description')
          <div class="invalid-feedback d-block">
            <i class="fa fa-times-circle"></i> {{ $message }}
          </div>
